...
[ES2015 and CommonJS modules](/examples/recipes#Fundamentals).
...
[save them to the cloud with Cypress Cloud](/guides/cloud/test-analytics/project-health#Run-Details).
...
&nbsp;<Icon name="exclamation-triangle" /> For a given testing type, multiple
matching `supportFile` files will result in an error when Cypress loads.
...
<DocsImage
  src="/img/guides/core-concepts/global-hooks.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-passing-test.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-failing-test.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-pending-tests.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-2-tests-passing.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-failed-and-skipped-tests.png"
...
<DocsImage
  src="/img/guides/core-concepts/todo-mvc-skipped-test.png"
